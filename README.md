...
1. Download the data files (`listings.csv`, `calendar.csv`, `reviews.csv`) from the Inside Airbnb website for Cape Town.
...
- **Matplotlib, Seaborn, and Plotly**: Libraries that enabled visualizations of data insights and trends in the exploratory data analysis.
...
- [**Peter**](https://github.com/PMabwa)
- [**Festus**](https://github.com/festus47)
- [**Kelvin**](https://github.com/kev065)
- [**Eric**](https://github.com/am-eric)
